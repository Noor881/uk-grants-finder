...
export const GUIDES = [
  {
    ...
    title: 'ECO4 Grant 2026: How to Get Free Insulation & Heating',
    excerpt: 'The ECO4 scheme funds free loft insulation, cavity wall insulation, heat pumps and boiler replacements for eligible UK households. Find out if you qualify and how to apply in 2026.',
    category: 'Energy Grants',
    readTime: '7 min read',
    date: '2026-04-01',
    keywords: ['ECO4 grant', 'free insulation', 'energy grants UK', 'ECO4 2026'],
    emoji: '🏠',
    color: '#0066ff',
  },
  {
    slug: 'universal-credit-guide',
    title: 'Universal Credit 2026: Full Eligibility Guide & How to Claim',
    excerpt: 'Universal Credit replaces 6 old benefits into one monthly payment. This guide explains who qualifies, how much you can get at April 2026 rates, and exactly how to make a claim on GOV.UK.',
    category: 'Benefits',
    readTime: '9 min read',
    date: '2026-04-06',
    keywords: ['Universal Credit', 'Universal Credit 2026', 'how to claim Universal Credit'],
    emoji: '🏛️',
    color: '#ffb300',
  },
  {
    slug: 'startup-grants-uk',
    title: 'UK Startup Grants 2026: Free Money for New Businesses',
    excerpt: 'From Innovate UK SMART grants to local Growth Hub funding, there are over 40 grant schemes available for UK startups and small businesses in 2026. Here\'s how to find and apply for them.',
    category: 'Business Grants',
    readTime: '8 min read',
    date: '2026-04-01',
    keywords: ['startup grants UK', 'UK business grants 2026', 'small business grants UK', 'Innovate UK'],
    emoji: '💼',
    color: '#7c3aed',
  },
  {
    slug: 'household-support-fund',
    title: 'Household Support Fund 2026: How to Get Emergency Council Help',
    excerpt: 'The Household Support Fund gives local councils money to help families with food, energy and essential costs. Extended into 2026/27 — find out how to claim in your area.',
    category: 'Cost of Living',
    readTime: '6 min read',
    date: '2026-04-06',
    keywords: ['Household Support Fund', 'council help 2026', 'cost of living grants UK'],
    emoji: '💳',
    color: '#26c6da',
  },
  {
  ...
  },
  {
    ...
    title: 'Council Tax Reduction 2026: How to Get a Discount or Exemption',
    excerpt: 'Millions of UK households are eligible for council tax reduction — including people on low incomes, Universal Credit claimants, disabled people, and full-time students. This guide explains exactly how to claim in 2026.',
    category: 'Cost of Living',
    readTime: '6 min read',
    date: '2026-04-01',
    keywords: ['council tax reduction', 'council tax discount UK', 'council tax exemption 2026'],
    emoji: '🏘️',
    color: '#00897b',
  },
  {
    slug: 'innovate-uk-grants',
    title: 'Innovate UK Grants 2026: How to Apply for Business R&D Funding',
    excerpt: 'Innovate UK funds thousands of UK businesses with SMART grants, Knowledge Transfer Partnerships and sector-specific R&D funding. This guide covers 2026 eligibility, timelines and how to write a winning application.',
    category: 'Business Grants',
    readTime: '8 min read',
    date: '2026-04-01',
  ...
  },
  {
    ...
    title: "Carer's Allowance 2026: Eligibility, Rates & How to Claim",
    excerpt: "Carer's Allowance is £83.30 per week from April 2026 for people who provide at least 35 hours of unpaid care. Millions of eligible carers never claim. This guide covers who qualifies, how much you get, and how to apply on GOV.UK.",
    category: 'Benefits',
    readTime: '7 min read',
    date: '2026-04-06',
    keywords: ["carer's allowance", "carer's allowance 2026", 'unpaid carer benefits UK'],
    emoji: '🤝',
    color: '#e65100',
  },
  {
    slug: 'free-childcare-guide',
    title: 'Free Childcare 2026: 15 & 30 Hours for UK Families Explained',
    excerpt: 'Working parents in England can claim up to 30 hours of free childcare per week. Now covering children from 9 months old, this guide covers 2026 eligibility, how to apply and what counts.',
    category: 'Family Support',
    readTime: '7 min read',
    date: '2026-04-01',
    keywords: ['free childcare UK', '30 hours free childcare', 'free childcare 2026'],
    emoji: '👶',
    color: '#6a1b9a',
  },
  {
    slug: 'uk-energy-grants-2025',
    title: 'UK Energy Grants 2026: Full List of Free Home Energy Schemes',
    excerpt: 'ECO4, Great British Insulation Scheme, Warm Home Discount, and more. This is the complete list of UK government energy grants available in 2026, including who qualifies and how to apply for each.',
    category: 'Energy Grants',
    readTime: '9 min read',
    date: '2026-04-06',
    keywords: ['UK energy grants 2026', 'free energy grants UK', 'home energy grants 2026', 'Warm Home Discount'],
    emoji: '⚡',
    color: '#f9a825',
  },
  {
    slug: 'london-grants-guide',
    title: 'London Grants 2026: Government Funding Available in the Capital',
    excerpt: 'A complete guide to government grants, business funding, and financial support available exclusively to London residents and businesses in 2026 — from GLA grants to borough-level schemes.',
    category: 'City Guides',
    readTime: '8 min read',
    date: '2026-04-06',
    keywords: ['London grants 2026', 'London business grants', 'GLA grants', 'London council grants'],
    emoji: '🏙️',
    color: '#0066ff',
  },
  {
    slug: 'manchester-grants-guide',
    title: 'Manchester Grants 2026: Funding for Businesses & Residents',
    excerpt: 'All government grants, council schemes, and financial support available in Greater Manchester in 2026 — including ECO4, GM Business Fund, and Manchester City Council grants.',
    category: 'City Guides',
    readTime: '7 min read',
    date: '2026-04-06',
    keywords: ['Manchester grants 2026', 'Greater Manchester business grants', 'Manchester City Council grants'],
    emoji: '🐝',
    color: '#f4a300',
  },
  {
    slug: 'birmingham-grants-guide',
    title: 'Birmingham Grants 2026: Council Funding for Residents & Businesses',
    excerpt: 'Birmingham City Council grants, West Midlands Combined Authority funding, and government schemes available to Birmingham residents and businesses in 2026.',
    category: 'City Guides',
    readTime: '7 min read',
    date: '2026-04-06',
    keywords: ['Birmingham grants 2026', 'Birmingham City Council grants', 'West Midlands grants'],
    emoji: '🏭',
    color: '#d32f2f',
  },
  {
    slug: 'scotland-grants-guide',
    title: 'Scotland Grants 2026: Scottish Government Funding You Can Claim',
    excerpt: 'Scottish Government grants, Business Gateway funding, Skills Development Scotland, and HEEPS energy grants available to Scottish residents and businesses in 2026.',
    category: 'City Guides',
    readTime: '8 min read',
    date: '2026-04-06',
    keywords: ['Scotland grants 2026', 'Scottish Government grants', 'Business Gateway Scotland', 'HEEPS Scotland'],
    emoji: '🏴󠁧󠁢󠁳󠁣󠁴󠁿',
    color: '#1a237e',
  },
  {
    slug: 'bristol-grants-guide',
    title: 'Bristol Grants 2026: Funding for Bristol Businesses & Residents',
    excerpt: 'Bristol City Council grants, West of England Growth Hub funding, and regional financial support schemes available in Bristol in 2026.',
    category: 'City Guides',
    readTime: '7 min read',
    date: '2026-04-06',
    keywords: ['Bristol grants 2026', 'Bristol business grants', 'West of England grants', 'Bristol City Council funding'],
    emoji: '🌉',
    color: '#00897b',
  },
  {
